...
class _Dropzone extends Vue {
  ...
  @Prop({ default: false })
  public useCustomDropzoneOptions!: boolean

  @Prop({ default: '48%' })
  public defaultImg!: string | [string]

  @Prop({ default: true })
  public couldPaste!: boolean

  public dropzone: any = null
  public initOnce: boolean = true
  ...
  mounted() {
    ...
    this.dropzone.on('success', (file: any) => {
    ...
    this.dropzone.on('error', (file: any, error: any, xhr: any) => {
      vm.$emit('dropzone-error', file, error, xhr)
    })
    this.dropzone.on('successmultiple', (file: any, error: any, xhr: any) => {
